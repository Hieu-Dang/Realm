package vn.haguyen.voiceexample;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_text = (EditText) findViewById(R.id.EdtInput);
        button = (Button) findViewById(R.id.btnSpeak);
        radio_en = (RadioButton) findViewById(R.id.RbtnEnglish);
        radio_fr = (RadioButton) findViewById(R.id.RbtnFrance);
    ...
    private Locale getUserSelectedLanguage() {
        ...
        if (checkedRadioId == R.id.RbtnEnglish) {
            return Locale.ENGLISH;
        } else if (checkedRadioId == R.id.RbtnFrance) {
